...
###############################################################################
def roll_call(*name):
    print(f"His last name is {name}")
roll_call("sid","steve", "james")    
###############################################################################
# DONE: 2. (3 pts)
#
...
###############################################################################
def pet_bio(**dog):
    print(f"my dog's name is " + dog["bio1"] + ". She is " + dog["bio2"] + " and she is a " + dog["bio3"] + ".")
pet_bio(bio1 = "Lucy", bio2 = "4 years old", bio3 = "hound")